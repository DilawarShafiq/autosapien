...
export function Technology() {
  ...
  return (
    <section id="technology" ref={containerRef} className="relative py-16 sm:py-32 overflow-hidden bg-carbon-900">
      ...
      {/* Geometric accent */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] border border-ember-500/5 hidden sm:block" style={{ transform: 'translate(-50%, -50%) rotate(45deg)' }} />
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-carbon-400 font-body max-w-2xl mx-auto">
        ...
        <div className="relative mb-24 overflow-hidden py-8">
          ...
          {/* Fade edges */}
          <div className="absolute inset-y-0 left-0 w-16 sm:w-32 bg-gradient-to-r from-carbon-900 to-transparent pointer-events-none" />
          <div className="absolute inset-y-0 right-0 w-16 sm:w-32 bg-gradient-to-l from-carbon-900 to-transparent pointer-events-none" />
        </div>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-24"
        >
          {metrics.map((metric, i) => (
            <motion.div
              ...
              className="card-industrial p-4 sm:p-8 text-center group hover-lift"
            >
