      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 sm:gap-12 mb-12 sm:mb-20">
          ...
          <div className="col-span-2">
            ...
            <p className="text-carbon-400 font-body text-sm mb-8 max-w-xs leading-relaxed">
          ...
          {/* Links columns */}
          <div>
            <h4 className="label-technical text-white mb-6">Company</h4>
          ...
          <div>
            <h4 className="label-technical text-white mb-6">Robotics</h4>
            <ul className="space-y-4">
          ...
          <div>
            <h4 className="label-technical text-white mb-6">Platforms</h4>
            <ul className="space-y-4">
          ...
          <div>
            <h4 className="label-technical text-white mb-6">Legal</h4>
            <ul className="space-y-4">
        ...
        {/* Corner accents */}
        <div className="absolute top-12 left-6 w-12 h-12 border-t border-l border-ember-500/20" />
        <div className="absolute bottom-12 right-6 w-12 h-12 border-b border-r border-ember-500/20" />
      </div>
    </footer>
  )
}
