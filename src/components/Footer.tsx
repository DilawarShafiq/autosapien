...
export function Footer() {
  ...
  return (
    <footer className="relative pt-12 sm:pt-24 pb-6 sm:pb-12 overflow-hidden bg-carbon-950">
      {/* Background */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-12 mb-12 sm:mb-20">
          ...
          <div className="col-span-2">
            ...
            <p className="text-carbon-400 font-body text-sm mb-6 sm:mb-8 max-w-xs leading-relaxed">
            ...
            <div className="flex gap-3">
              {['linkedin', 'twitter', 'github', 'youtube'].map((social) => (
                <a
                  key={social}
                  href={`#${social}`}
                  className="w-10 h-10 border border-carbon-700 flex items-center justify-center hover:border-ember-500 hover:bg-ember-500/10 transition-all group"
                >
                  {social === 'linkedin' && (
                    <svg className="w-4 h-4 text-carbon-500 group-hover:text-ember-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-3 sm:space-y-4">
              {footerLinks.company.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-sm text-carbon-500 font-body hover:text-ember-400 transition-colors"
                  >
                    {link.name}
                  </a>
                </li>
        ...
        <div className="pt-8 border-t border-carbon-800">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <button
                onClick={scrollToTop}
                className="w-12 h-12 border border-carbon-700 flex items-center justify-center hover:border-ember-500 hover:bg-ember-500/10 transition-all group"
                aria-label="Scroll to top"
              >
                <ArrowUp className="w-5 h-5 text-carbon-500 group-hover:text-ember-400 transition-colors" />
              </button>
            </div>
          </div>
        </div>
        ...
        {/* Corner accents */}
        <div className="absolute top-12 left-6 w-12 h-12 border-t border-l border-ember-500/20 hidden sm:block" />
        <div className="absolute bottom-12 right-6 w-12 h-12 border-b border-r border-ember-500/20 hidden sm:block" />
      </div>
    </footer>
  )
}
