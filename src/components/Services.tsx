...
const services = [
  ...
  },
  {
    ...
    featured: true,
    caseStudy: {
      name: 'the Autosapien agentic platform',
      label: 'Active Engagement',
      blurb:
        'Currently in development for an enterprise client—the Autosapien agentic platform is a custom multi-agentic platform orchestrating specialised agents across the client’s operations stack.',
    },
  },
]
