...
export function Contact() {
  ...
  return (
    <section id="contact" className="relative py-16 sm:py-32 overflow-hidden bg-carbon-850">
      ...
      {/* Geometric accents */}
      <div className="absolute bottom-0 left-1/4 w-64 h-64 border border-ember-500/10 hidden sm:block" style={{ transform: 'rotate(45deg)' }} />
      <div className="absolute top-1/4 right-1/4 w-48 h-48 border border-volt-500/10 hidden sm:block" style={{ transform: 'rotate(45deg)' }} />
      ...
      <div ref={ref} className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-carbon-400 font-body max-w-2xl mx-auto mb-10 sm:mb-16">
          ...
          >
            <a
              ...
              className="inline-block card-industrial p-6 sm:p-8 corner-accent group hover-lift"
            >
