...
export const agenticHealthcareModules: AcademyModule[] = [
...

  {
    ...
    subtitle: 'xEHR.io, the Autosapien Agent Platform & the RCM Automation Platform',
