...
export const agenticHealthcareModules: AcademyModule[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        tags: ['Digital-FTE', 'panaversity', 'agent-architecture', 'Agent-SMITH', 'healthcare-AI'],
      },
    ],
  },
...

  {
    ...
    subtitle: 'xEHR.io, Agent SMITH & the RCM Automation Platform',
    ...
    lessons: [
      ...
      },
      {
        ...
        duration: '55 min',
        overview: 'Agent SMITH is Autosapien\'s HIPAA-compliant agentic AI platform — the orchestration layer that turns specialized AI capabilities into deployed Digital FTEs. This lesson walks through deploying a Personal Medical Biller on Agent SMITH from configuration to live production.',
        keyInsights: [
